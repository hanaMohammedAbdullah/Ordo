                ...
                <div className="flex flex-wrap -mx-4">
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8 md:mb-0 text-center">
                        ...
                        <p className="mb-4">
                            ...
                            elit. Mauris euismod quam nec nisi facilisis, vel
                            pulvinar leo consectetur.
                        </p>
                        <p className="mb-4">
                            Donec vestibulum dapibus leo, at malesuada neque
                            commodo in. Nulla vitae leo sapien. Nulla commodo
                            efficitur elit, et blandit nulla dictum a.
                        </p>
                    </div>

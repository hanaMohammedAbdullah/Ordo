...
const SubCategoryFix = ({ food, setShowModal }) => {
                ...
                <div className="relative w-2/3 h-96  my-6 mx-auto max-w-3xl">
                    ...
                    <div className="border-0  h-full rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                            <h3 className="text-3xl font-semibold">SubCategory Update</h3>
                            <button
                        ...
                        <div className="relative p-6 flex-auto">
                            ...
                            <input
                                // ref={nameref}
                                className="border rounded-sm  w-11/12 m-1 border-yellow-400"
                                type="text"
                        ...
                        <div className="relative p-6 flex-auto">
                            ...
                            <input
                                ...
                                className="border rounded-sm  w-11/12 m-1 border-yellow-400"
                                type="text"
                                placeholder="Enter your Update name SubCategory "
                            />
                        </div>
                        {/*footer*/}
